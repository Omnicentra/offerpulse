...
const cursorPaths: CursorPosition[][] = [
  [{ x: 120, y: 220, click: true }], // Frame 1: Click Add to cart
  [{ x: 120, y: 300, click: true }], // Frame 2: Click Checkout
  [{ x: 200, y: 160 }], // Frame 3: Hover shipping line
  [{ x: 180, y: 250 }], // Frame 4: Scan offers
        ...
        <div className="relative h-[460px] overflow-hidden p-6 sm:p-8">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Offer stack - staggered animation (Frame 4 only) */}
              {frame.elements.offers && !frame.elements.showSummary && (
                <motion.div
              ...
              {/* Offer change summary panel - Frame 5 only, separate from offers */}
