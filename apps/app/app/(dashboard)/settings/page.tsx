...
import { workspaceSettingsApi, resetApi } from "@/src/mock/api";
import { Settings, Users, CreditCard, RefreshCw, ChevronRight } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const { data: settings, isLoading } = useQuery({
    ...
    queryFn: () => workspaceSettingsApi.get(),
  });
  ...
  const updateMutation = useMutation({
    mutationFn: workspaceSettingsApi.update,
    onSuccess: () => {
