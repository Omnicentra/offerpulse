...
function ChangesPageSkeleton() {
  return (
    <div className="space-y-6">
      <PageHeader compact title="Changes" />
...
export default function ChangesPage() {
  ...
  const { data: allChanges, isLoading: changesLoading } = useQuery({
    ...trpc.changeEvents.list.queryOptions({ workspaceId: workspaceId! }),
    enabled: !!workspaceId,
  });

  const isLoading = competitorsLoading || changesLoading;
